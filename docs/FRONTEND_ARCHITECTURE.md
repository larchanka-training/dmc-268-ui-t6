...
api#19): п. 2, 4, 6, 7, 8, 9 — в [§12][sd-12], п. 10 — в [§2][sd-2] и [§12][sd-12]; п. 1 [SD][sd]
покрывал и раньше (Zod — источник истины).
П. 3 и 5 — реализация роли 6 (api #17). Прод-раздача UI из п. 10 ([§14][sd-14]) переписывается в api PR #10.
