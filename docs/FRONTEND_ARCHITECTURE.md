...
| Ф-11 | Vitest 3.2.7, а не 4.x (отклонение от плана роли 5)                                       | vitest 4 требует Vite ≥ 6, проект зафиксирован на Vite 5 (роль 4); бамп — follow-up (§11).                |
| Ф-12 | React 18.3.1 без бампа; react-router 7 / Mantine 8 только названы, не установлены         | SD фиксирует React 18; v8/v9 требуют React ≥ 19.2 (§9, §11).                                              |
...
- **Vitest 4** — после бампа Vite до 7 (роль 4); в плане роли 5 была 4.x, установлена 3.2.7 — см. Ф-11.
